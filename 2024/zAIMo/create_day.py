...
def create_day_folder(day_number):
    ...
    main_content = f'''def process_part1(input_file):
    return None
...
def part_1():
    example_result = process_part1(input_file='day{day_number}/example.txt')
    result = process_part1(input_file='day{day_number}/input.txt')

    print(f"Example result: {{example_result}}")
    print(f"Result: {{result}}")

def part_2():
    example_result = process_part2(input_file='day{day_number}/example.txt')
    result = process_part2(input_file='day{day_number}/input.txt')
